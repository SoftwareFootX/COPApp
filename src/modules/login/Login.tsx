    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/20 via-white to-primary/10 px-4 py-10">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative z-10 py-2 px-4 rounded-3xl text-gray-800 bg-primary/15">
          <img src={cop_logo} alt="logo-footx" className="h-15 my-10 mx-auto" />
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center border border-white/50 bg-white/40 backdrop-blur-sm rounded-full px-4 focus-within:ring-2 focus-within:ring-primary/60 focus-within:border-primary transition">
                ...
                <button
                  type="button"
                  className="text-primary text-xl flex items-center cursor-pointer"
                  onClick={(e) => {
                    e.preventDefault();
            ...
            <div className="w-full flex justify-center">
              <button
                type="submit"
                disabled={loading}
                className="w-2/3 bg-primary text-white py-1 rounded-full font-semibold text-lg hover:bg-primary/80 active:scale-[0.98] transition disabled:opacity-50 shadow-lg cursor-pointer"
              >
          ...
          <a
            ...
            className="flex items-center gap-2 justify-center mt-6 text-primary hover:underline cursor-pointer"
          >
